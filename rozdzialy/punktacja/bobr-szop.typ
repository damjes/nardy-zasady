...
Na szopa można odpowiedzieć rekontrą w postaci _mrównika_ (_aardvark_), _wydry_ (_otter_) lub innego zwierzęcia. Kość zawsze zostaje do~dyspozycji gracza, któremu zaöferowano pierwotne podwojenie. Zasady dotyczące kolejnych zwierząt są stosowane jeszcze rzadziej, niż zasady w/w.
