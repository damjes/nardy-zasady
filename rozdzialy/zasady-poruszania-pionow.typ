...
#figure(image("../tmp/schematy.pdf", page: 6, width: 80%))
...
#block(breakable: false)[
	...
	#figure(image("../tmp/schematy.pdf", page: 4, width: 80%, height: 40%, fit: "contain"))

	#figure(image("../tmp/schematy.pdf", page: 5, width: 80%, height: 40%, fit: "contain"))
]
