...
- dwie zwykłe sześcienne kości do~gry K6 (nie jest możliwe użycie kości Sichermana);
...
#przyklej[Brytyjska Federacja Nard (UKBGF) wskazuje na~#link("https://ukbgf.com/members/articles/the-newcomers-guide-to-clocks/")[swojej stronie] następujące korzyści z~użycia zegara:]
...
Nick Ballard zaproponował użycie kości Sichermana do~nard i~nazwał ten wariant Sichgammonem. Film jest dostępny pod~adresem #link("https://www.youtube.com/watch?v=8-ROEd244tw")[https://www.youtube.com/watch?v=8-ROEd244tw].
...
Zgodnie z~#link("https://www.bkgm.com/faq/BasicRules.html#what_is_the_24_point_numbering_system_")[bkgm.com] kiedyś (do~lat 1980) numerowano pola od~1 do~12 i~przeciwne pola miały te same numery. W~celu odróżnienia pól stosowano prefiksy, eg.~W12 lub~B12.

== Czym różnią się krótkie i~długie nardy?

Krótkie nardy to wschodnia (eg.~rosyjska) nazwa na~grę, której dotyczą niniejsze zasady. Ma ona kontrastować z~nazwą "długie nardy", czyli inną grą na~tej samej planszy. Zasady w~długie nardy opisuje #link("https://en.wikipedia.org/wiki/Long_Nardy")[angielska wikipedia]. Podstawowe różnice to zgodny ruch (obaj gracze idą w~tę samą stronę) i~pozycja początkowa z~15 pionami na~jednym polu.
...
- plansza powinna być duża (w~tzw. rozmiarze turniejowym) z~dużymi pionami, czyli:
	- 440x550-660x880 mm dla~turniejów #link("https://www.backgammonworldchampionship.com/s/1-BGWC-2025-Tournament-Rules-A4-BW.pdf")[BGWC],
	- dostosowana do~pionów o~średnicy 37-50 mm dla~#link("https://wbgf.info/tournament-rules/")[WBGF];
...
Jasne, turnieje, o~których wspominałem w~poprzednim pytaniu czasami można oglądać na~YouTubie, eg.~finał mistrzostw BGWC jest #link("https://www.youtube.com/watch?v=Ow_-WNcpLKo")[tutaj]. Na~tego typu filmach można w~praktyce zobaczyć, jak ruszają się piony, czy też~jak używa się zegara.
