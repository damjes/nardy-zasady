...
- dwie zwykłe sześcienne kości do~gry K6 (nie jest możliwe użycie kości Sichermana#footnote[patrz sekcja @sicherman]);
...
Oznacza to, że~plansza podzielona jest na~cztery ćwiartki po~sześć pól każda. Ułożenie planszy pomiędzy graczami można zaobserwować na~rycinie powyżej.
